...
namespace LINQTut13.Concatenation
{
    internal class Program
    {
        ...
        static void RunMethod04()
        {
            ...
            //Important note....
            var quiz03 = new[] { quiz1, quiz2 };
            quiz03.SelectMany(x => x);


            // quiz03.ToQuiz();//This is wrong because type of quiz03 is array didn't change until after applied selectMany , if i need apply ToQuiz , i should apply it on result selectMany direct...
        }
